...
![Raw Log](screenshots/wp-scan/splunk-raw-access-log.png)
...
![IP Location](screenshots/wp-scan/iplocation-country-analysis.png)
...
![User Agent](screenshots/wp-scan/useragent.png)
...
![Timeline](screenshots/wp-scan/timeline-reconstruction.png)
![Simple File List](screenshots/wp-scan/simple-file-list-exploit.png)
![Upload](screenshots/wp-scan/fr34k_upload.png)
...
![Vulnerability](screenshots/wp-scan/simple-file-list-vulnerability.png)
